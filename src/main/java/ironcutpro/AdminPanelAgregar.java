 ...
 * @author main_
 */
public class AdminPanelAgregar extends javax.swing.JFrame {

    /**
     * Creates new form AdminPanelHome
     */
    public AdminPanelAgregar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("CONTRASEÑA NUEVO USUARIO");
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 420, -1, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel5.setForeground(java.awt.Color.orange);
        jLabel5.setText("NOMBRE NUEVO USUARIO");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, -1, -1));
        getContentPane().add(T1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 190, 220, -1));
        getContentPane().add(T2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 260, 240, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 310, 220, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(AdminPanelAgregar.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        AdminPanelHome h=new AdminPanelHome();
        h.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminPanelAgregar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminPanelAgregar().setVisible(true);
            }
        });
    }
